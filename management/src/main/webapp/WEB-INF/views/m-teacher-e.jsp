...
<body style="background-color: #ffffff;">
	<div class="easyui-tabs" style="width: 100%; height: 800px;">
		<div title="<spring:message code="teacher.management.detail"/>"
			style="padding: 10px">
			<form action="saveTeacher.html" method="post"
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"
							...
							<label style="height: 25px; margin-top: 2px; text-align: right;"><spring:message
									code="teacher.truename" /></label>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							style="border: 1px solid #4B306C; height: 30px;">
							<input type="text" name="truename"
								style="height: 25px; width: 500px; margin-top: 2px;"
								value='<c:out value="${tbTeacher.truename}"/>'><span
					...
					<div class="row">
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"
							style="border: 1px solid #4B306C; height: 30px;">
							<label style="height: 25px; margin-top: 2px; text-align: right;"><spring:message
									code="teacher.username" /></label>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							style="border: 1px solid #4B306C; height: 30px;">
							<input type="text" name="username"
								style="height: 25px; width: 500px; margin-top: 2px;"
								value='<c:out value="${tbTeacher.username}"/>'> <span
								class="requireText">*</span>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"
							style="border: 1px solid #4B306C; height: 30px;">
							<label style="height: 25px; margin-top: 2px; text-align: right;"><spring:message
									code="teacher.idcard" /></label>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							style="border: 1px solid #4B306C; height: 30px;">
							<input type="text" name="idcard"
								style="height: 25px; width: 500px; margin-top: 2px;"
								value='<c:out value="${tbTeacher.idcard}"/>'> <span
								class="requireText">*</span>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"
							style="border: 1px solid #4B306C; height: 30px;">
							<label style="height: 25px; margin-top: 2px; text-align: right;"><spring:message
									code="teacher.certificate" /></label>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							style="border: 1px solid #4B306C; height: 30px;">
							<input type="text" name="certificate"
								style="height: 25px; width: 500px; margin-top: 2px;"
								value='<c:out value="${tbTeacher.certificate}"/>'> <span
								class="requireText">*</span>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"
							style="border: 1px solid #4B306C; height: 30px;">
							<label style="height: 25px; margin-top: 2px; text-align: right;"><spring:message
									code="teacher.email" /></label>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							style="border: 1px solid #4B306C; height: 30px;">
							<input type="text" name="email"
								style="height: 25px; width: 500px; margin-top: 2px;"
								value='<c:out value="${tbTeacher.email}"/>'> <span
								class="requireText">*</span>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"
							style="border: 1px solid #4B306C; height: 30px;">
							<label style="height: 25px; margin-top: 2px; text-align: right;"><spring:message
									code="teacher.mobile" /></label>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							style="border: 1px solid #4B306C; height: 30px;">
							<input type="text" name="mobile"
								style="height: 25px; width: 500px; margin-top: 2px;"
								value='<c:out value="${tbTeacher.mobile}"/>'> <span
								class="requireText">*</span>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"
							style="border: 1px solid #4B306C; height: 30px;">
							<label style="height: 25px; margin-top: 2px; text-align: right;"><spring:message
									code="teacher.birthday" /></label>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							style="border: 1px solid #4B306C; height: 30px;">
							<input type="text" name="birthday"
								style="height: 25px; width: 500px; margin-top: 2px;"
								value='<c:out value="${tbTeacher.birthday}"/>'>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"
							style="border: 1px solid #4B306C; height: 30px;">
							<label style="height: 25px; margin-top: 2px; text-align: right;"><spring:message
									code="teacher.sex" /></label>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							style="border: 1px solid #4B306C; height: 30px;">
							<select name="sex" id="sex_id">
								<c:if test="${tbTeacher.sex eq '0'}">
									<option value="0" selected="selected"><spring:message
											code="teacher.sex.male" /></option>
									<option value="1"><spring:message
											code="teacher.sex.female" /></option>
								</c:if>
								<c:if test="${tbTeacher.sex eq '1'}">
					...
					<div class="row">
						...
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							...
							<select name="status" id="status_id">
								<c:if test="${tbTeacher.status eq '0'}">
									<option value="0" selected="selected"><spring:message
											code="teacher.status.off" /></option>
									<option value="1"><spring:message
											code="teacher.status.on" /></option>
								</c:if>
								<c:if test="${tbTeacher.status eq '1'}">
									<option value="0"><spring:message
											code="teacher.status.off" /></option>
									<option value="1" selected="selected"><spring:message
											code="teacher.status.on" /></option>
					...
					<div class="row">
						...
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10"
							...
							<textarea rows="10" name="resume" cols="68"><c:out
									value="${tbTeacher.resume}" /></textarea>
						</div>
					</div>
					<div class="row">
